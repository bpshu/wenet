...
train_config=conf/train_unified_conformer.005.yaml
cmvn=true
dir=exp/unified_conformer_005
checkpoint=
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    bash local/prepare_data.sh --stage 0 --stop_stage 7
fi
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    {
        test_dir=$dir/test_${mode}_${decoding_chunk_size}
        mkdir -p $test_dir
